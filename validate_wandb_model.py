...
def main():
    ...
    # run_validation_epoch already performs 10 sample batch passes, matching your training validation methodology.
    val_loss, val_acc = run_validation_epoch(modules, dataset, phase='ae', batch_size=args.batch_size, device=device)
